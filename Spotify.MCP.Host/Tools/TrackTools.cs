...
public class TrackTools
{
    ...
    [McpServerTool, Description("Get details about a specific track by its Spotify ID")]
        ...
        [Description("Optional access token for user-specific data")] string? accessToken = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            return $"Error retrieving track: {ex.Message}";
        }
    }

    [McpServerTool, Description("Get details about multiple tracks by their Spotify IDs")]
        ...
        [Description("Optional access token for user-specific data")] string? accessToken = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            return $"Error retrieving tracks: {ex.Message}";
        }
    }

    [McpServerTool, Description("Get audio features for a track (acousticness, danceability, energy, etc.)")]
        ...
        [Description("Optional access token for user-specific data")] string? accessToken = null)
    {
        try
        {
            ...
            if (audioFeatures == null)
                return $"Audio features for track '{trackId}' not found.";
        ...
        catch (Exception ex)
        {
            ...
            return $"Error retrieving audio features: {ex.Message}";
        }
    }

    [McpServerTool, Description("Get audio features for multiple tracks")]
